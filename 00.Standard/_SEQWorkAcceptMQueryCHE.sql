...
IF OBJECT_ID('_SEQWorkAcceptMQueryCHE') IS NOT NULL
    DROP PROC _SEQWorkAcceptMQueryCHE
GO 
...
/************************************************************  
  ...
  작성자 - 김수용  
 ************************************************************/  
 CREATE PROC [dbo].[_SEQWorkAcceptMQueryCHE]  
 ...
 AS  
     ...
     RETURN
GO 
exec _SEQWorkAcceptMQueryCHE @xmlDocument=N'<ROOT>
  <DataBlock1>
