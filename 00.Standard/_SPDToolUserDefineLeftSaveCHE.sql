...
IF OBJECT_ID('_SPDToolUserDefineLeftSaveCHE') IS NOT NULL 
    DROP PROC _SPDToolUserDefineLeftSaveCHE
GO 
...
/************************************************************  
 ...
 작성자 - 
 ************************************************************/  
 CREATE PROC dbo._SPDToolUserDefineLeftSaveCHE 
 ...
 AS      
     ...
     EXEC dbo._SCAOpenXmlToTemp @xmlDocument, @xmlFlags, @CompanySeq, @ServiceSeq, 'DataBlock2', '#TPDToolUserDefine'       
     IF @@ERROR <> 0 RETURN      
