...
IF OBJECT_ID('yw_SACSalesReceiptPlanDomCheck') IS NOT NULL   
    DROP PROC yw_SACSalesReceiptPlanDomCheck  
GO  
  
-- v2013.12.12  
  
-- 채권수금계획(내수)_yw-체크 by 이재천   
CREATE PROC yw_SACSalesReceiptPlanDomCheck  
...
AS   
    ...
    RETURN  
GO
exec yw_SACSalesReceiptPlanDomCheck @xmlDocument=N'<ROOT>
  <DataBlock1>
