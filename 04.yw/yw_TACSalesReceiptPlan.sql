IF NOT EXISTS (SELECT * FROM Sysobjects where Name = 'yw_TACSalesReceiptPlan' AND xtype = 'U' )
    BEGIN
        CREATE TABLE yw_TACSalesReceiptPlan
        (
        ...
        ReceiptAmt6		DECIMAL(19,5) 	 NOT NULL, 
        ...
        ReceiptDomAmt6		DECIMAL(19,5) 	 NULL, 
        LongBondDomAmt		DECIMAL(19,5) 	 NULL, 
        BadBondDomAmt		DECIMAL(19,5) 	 NULL, 
        LastUserSeq		INT 	 NOT NULL, 
        LastDateTime		DATETIME 	 NOT NULL, 
        PgmSeq		INT 	 NOT NULL, 
        CONSTRAINT PKyw_TACSalesReceiptPlan PRIMARY KEY CLUSTERED (CompanySeq ASC, PlanYM ASC, PlanType ASC, Serl ASC)
        )
    END

IF NOT EXISTS (SELECT * FROM Sysobjects where Name = 'yw_TACSalesReceiptPlanLog' AND xtype = 'U' )
    BEGIN
        CREATE TABLE yw_TACSalesReceiptPlanLog
        (
        ...
        CREATE UNIQUE CLUSTERED INDEX IDXTempyw_TACSalesReceiptPlanLog ON yw_TACSalesReceiptPlanLog (LogSeq)
    END