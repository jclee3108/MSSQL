...
IF OBJECT_ID('KPXCM_SEQWorkAcceptDQueryCHE') IS NOT NULL 
    DROP PROC KPXCM_SEQWorkAcceptDQueryCHE
GO 
...
-- v2014.12.04 
  /************************************************************  
   ...
   작성자 - 김수용  
  ************************************************************/  
  CREATE PROC KPXCM_SEQWorkAcceptDQueryCHE
  ...
  AS  
      ...
      SELECT 0 AS Sel,  
              ...
              PdAccUnitSeq AS FactUnit,  
              H.FactUnitName AS FactUnitName,  
              B.ToolSeq,  
