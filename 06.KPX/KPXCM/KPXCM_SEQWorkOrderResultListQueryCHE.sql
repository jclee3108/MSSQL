...
AS    
    ...
    SELECT DISTINCT  A.WorkType        ,
      ...
      LEFT OUTER JOIN _TDAUMinorValue                   AS W1 ON 1 = 1 AND A.CompanySeq = W1.CompanySeq AND A.WorkType = W1.MinorSeq AND W1.MinorSeq = 20104005 AND W1.Serl = 1000001 -- 일반작업
      LEFT OUTER JOIN _TDAUMinorValue                   AS W2 ON 1 = 1 AND A.CompanySeq = W2.CompanySeq AND A.WorkType = W2.MinorSeq AND W2.MinorSeq IN (20104001, 20104002) AND W2.Serl = 1000002 -- 자산화/특수
      LEFT OUTER JOIN _TDAUMinorValue                   AS W3 ON 1 = 1 AND A.CompanySeq = W3.CompanySeq AND A.WorkType = W3.MinorSeq AND W3.MinorSeq = 20104004 AND W3.Serl = 1000001 -- 예방정비
      LEFT OUTER JOIN (
