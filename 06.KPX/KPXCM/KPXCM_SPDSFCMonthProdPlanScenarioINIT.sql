...
IF OBJECT_ID('KPXCM_SPDSFCMonthProdPlanScenarioINIT') IS NOT NULL   
    DROP PROC KPXCM_SPDSFCMonthProdPlanScenarioINIT  
GO  
    
-- v2016.05.24 
  
-- 생산계획시나리오-INIT by 이재천 
CREATE PROC KPXCM_SPDSFCMonthProdPlanScenarioINIT  
...
AS   
    ...
    RETURN  
GO 
exec KPXCM_SPDSFCMonthProdPlanScenarioINIT @xmlDocument=N'<ROOT>
  <DataBlock1>
