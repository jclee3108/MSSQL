...
IF OBJECT_ID('KPXCM_SPDSFCMonthProdPlanScenarioItemCheck') IS NOT NULL   
    DROP PROC KPXCM_SPDSFCMonthProdPlanScenarioItemCheck  
GO  
  
-- v2016.05.24
  
-- 생산계획시나리오-체크 by 이재천   
CREATE PROC KPXCM_SPDSFCMonthProdPlanScenarioItemCheck  
...
go
begin tran 
exec KPXCM_SPDSFCMonthProdPlanScenarioItemCheck @xmlDocument=N'<ROOT>
  <DataBlock2>
