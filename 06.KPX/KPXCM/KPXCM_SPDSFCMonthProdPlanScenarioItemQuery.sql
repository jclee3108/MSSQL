...
IF OBJECT_ID('KPXCM_SPDSFCMonthProdPlanScenarioItemQuery') IS NOT NULL   
    DROP PROC KPXCM_SPDSFCMonthProdPlanScenarioItemQuery  
GO  
  
-- v2016.05.24 
  
-- 생산계획시나리오-조회 by 이재천   
CREATE PROC KPXCM_SPDSFCMonthProdPlanScenarioItemQuery  
...
AS  
    ...
    SELECT A.PlanSeq, 
      ...
      LEFT OUTER JOIN KPXCM_TPDSFCMonthProdPlanScenario AS I ON ( I.CompanySeq = @CompanySeq AND I.PlanSeq = A.PlanSeq AND I.PlanYMSub = A.PlanYMSub ) 
    ...
    RETURN  
GO
exec KPXCM_SPDSFCMonthProdPlanScenarioItemQuery @xmlDocument=N'<ROOT>
  <DataBlock2>
