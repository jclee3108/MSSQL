...
IF OBJECT_ID('KPXCM_SPDSFCMonthProdPlanStockQuery') IS NOT NULL   
    DROP PROC KPXCM_SPDSFCMonthProdPlanStockQuery  
GO  
  
-- v2015.10.20  
  
-- 월생산계획-조회 by 이재천   
CREATE PROC KPXCM_SPDSFCMonthProdPlanStockQuery  
...
AS  
    ...
    RETURN  
go
exec KPXCM_SPDSFCMonthProdPlanStockQuery @xmlDocument=N'<ROOT>
  <DataBlock1>
