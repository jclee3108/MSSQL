IF OBJECT_ID('KPXCM_SPDSFCWorkReportMatOutWhSave') IS NOT NULL 
    DROP PROC KPXCM_SPDSFCWorkReportMatOutWhSave
GO 
 ...
 ************************************************************/   
 CREATE PROC KPXCM_SPDSFCWorkReportMatOutWhSave
        ...
        UPDATE A
          ...
          JOIN ( 
                SELECT A.ValueSeq AS OutWHSeq, B.ValueSeq AS FactUnit, C.ValueSeq AS AssetSeq 
                  ...
                  JOIN _TDAUMinorValue AS B ON ( B.CompanySeq = A.CompanySeq AND B.MinorSeq = A.MinorSeq AND B.Serl = 1000001 ) -- 생산사업장 
                  JOIN _TDAUMinorValue AS C ON ( C.CompanySeq = A.CompanySeq AND C.MinorSeq = A.MinorSeq AND C.Serl = 1000002 ) -- 품목자산분류 
                 WHERE A.CompanySeq = @CompanySeq 
