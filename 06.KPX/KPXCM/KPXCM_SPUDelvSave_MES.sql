IF OBJECT_ID('KPXCM_SPUDelvSave_MES') IS NOT NULL    
    DROP PROC KPXCM_SPUDelvSave_MES
GO 
 ...
 ************************************************************/     
 CREATE PROC KPXCM_SPUDelvSave_MES     
 ...
 --                IsPJT        = B.IsPJT        ,
    ...
    SELECT @Status = (SELECT MAX(Status) FROM #TPUDelv )  
