...
IF OBJECT_ID('KPXCM_SSEAccidentCopyQueryCHE') IS NOT NULL 
    DROP PROC KPXCM_SSEAccidentCopyQueryCHE
GO 
...
/************************************************************
   ...
   작성자 - 박헌기
  ************************************************************/
  CREATE PROC dbo.KPXCM_SSEAccidentCopyQueryCHE
  ...
  AS
      ...
      SELECT A.AccidentSeq        ,
        ...
        FROM _TSEAccidentCHE AS A WITH(NOLOCK)
             JOIN KPXCM_TSEDesasterCHE     AS A1 WITH (NOLOCK) ON A.CompanySeq = A1.CompanySeq 
                                                         AND A.AccidentSeq = A1.AccidentSeq    
       ...
       WHERE A.CompanySeq   = @CompanySeq
         AND A.AccidentSerl = '2' -- @AccidentSerl -- ('1' : 사고발생보고등록, '2' : 사고조사등록)
