if object_id('KPXCM_TPDSFCMonthProdPlanStock') is null 
begin 
    CREATE TABLE KPXCM_TPDSFCMonthProdPlanStock
    (
    ...
    create unique clustered index idx_KPXCM_TPDSFCMonthProdPlanStock on KPXCM_TPDSFCMonthProdPlanStock(CompanySeq,PlanSeq,PlanYMSub) 
end 

if object_id('KPXCM_TPDSFCMonthProdPlanStockLog') is null 
begin 
CREATE TABLE KPXCM_TPDSFCMonthProdPlanStockLog
(
