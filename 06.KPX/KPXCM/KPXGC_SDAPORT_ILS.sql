IF OBJECT_ID('KPXGC_SDAPORT_ILS') IS NOT NULL 
    DROP PROC KPXGC_SDAPORT_ILS
GO 
...
AS
    ...
    INSERT INTO KPXCM.dbo.PORT_IF 
    SELECT CUST_GRP, COMM_ID, COMM_NM, LOC_CD, WORK_FLAG, SEND_FLAG
      FROM PORT_IF
     WHERE Send_Flag = '0' 
