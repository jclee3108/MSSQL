...
IF OBJECT_ID('KPX_SACFundSumListQuery') IS NOT NULL   
    DROP PROC KPX_SACFundSumListQuery  
GO  
  
-- v2015.04.24  
  
-- 상품운용현황(집계)-조회 by 이재천   
CREATE PROC KPX_SACFundSumListQuery  
...
exec KPX_SACFundSumListQuery @xmlDocument=N'<ROOT>
  <DataBlock1>
    ...
    <MultiUMHelpCom>&amp;lt;XmlString&amp;gt;&amp;lt;/XmlString&amp;gt;</MultiUMHelpCom>
    <UMBond />
    <FundName />
  </DataBlock1>
</ROOT>',@xmlFlags=2,@ServiceSeq=1027152,@WorkingTag=N'',@CompanySeq=1,@LanguageSeq=1,@UserSeq=50322,@PgmSeq=1024520