...
IF OBJECT_ID('KPX_SARBizTripCostItemQuery') IS NOT NULL 
    DROP PROC KPX_SARBizTripCostItemQuery
GO 

-- v2015.01.08 

-- 출장비지출품의서-Item조회 by 이재천
 CREATE PROC KPX_SARBizTripCostItemQuery  
 ...
 AS  
    ...
    INSERT INTO #TSIAFebCardCfm
    SELECT CARD_CD, APPR_DATE,APPR_SEQ,APPR_No,CANCEL_YN
...
GO 
begin tran 
exec KPX_SARBizTripCostItemQuery @xmlDocument=N'<ROOT>
  <DataBlock2>
