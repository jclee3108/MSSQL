...
IF OBJECT_ID('KPX_SPDQCRequestInsPurchaseImpDelvCheck') IS NOT NULL   
    DROP PROC KPX_SPDQCRequestInsPurchaseImpDelvCheck  
GO  

-- v2015.01.27 
  
-- 수입입고입력-수입의뢰데이터 생성 체크 by 이재천   
CREATE PROC KPX_SPDQCRequestInsPurchaseImpDelvCheck  
