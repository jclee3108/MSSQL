...
IF OBJECT_ID('KPX_SPDQCRequestInsPurchaseImpDelvSave') IS NOT NULL   
    DROP PROC KPX_SPDQCRequestInsPurchaseImpDelvSave  
GO  
  
-- v2015.01.27 
  
-- 수입입고입력-수입검사의뢰데이터 생성 by 이재천 
CREATE PROC KPX_SPDQCRequestInsPurchaseImpDelvSave  
...
AS    
    ...
    --ALTER TABLE #KPX_TPDQCRequestInsPurchaseSub ADD UMImpType INT NULL 
    
    --UPDATE #KPX_TPDQCRequestInsPurchaseSub
    --   SET UMImpType = 1010619002
    
    UPDATE A
       SET SMSourceType = 1000522007 
