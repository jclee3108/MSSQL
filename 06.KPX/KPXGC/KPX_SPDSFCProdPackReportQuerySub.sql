IF OBJECT_ID('KPX_SPDSFCProdPackReportQuerySub') IS NOT NULL 
    DROP PROC KPX_SPDSFCProdPackReportQuerySub
GO 

-- v2014.11.27 

-- 포장작업실적입력-품목Sub 조회 by 이재천   
CREATE PROC dbo.KPX_SPDSFCProdPackReportQuerySub                
