...
AS           
  ...
  --select * from _TDAUmajor where majorseq = 1010418
    UPDATE A  
       SET A.SMQcType    = CASE WHEN A.IsPass = '1' THEN 1010418001 ELSE 1010418004 END   --미검사  
      FROM #Result AS A   
    ...
    UPDATE A  
       SET A.SMQcType    = CASE B.SMTestResult WHEN 6035001 /*무검사*/ THEN 1010418005 --무검사  
