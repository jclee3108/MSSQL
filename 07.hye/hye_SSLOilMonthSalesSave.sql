...
AS   
    ...
    UPDATE A
       SET in_qty           = B.in_qty -- 입고량 
          ,re_in_qty        = B.re_in_qty -- 반입량 
          ,re_out_qty       = B.re_out_qty -- 반출량 
          ,real_qty         = B.real_qty -- 실측재고  
          ,next_month_qty   = B.next_month_qty -- 차기이월
          ,descr            = B.descr -- 적요 
      FROM pos810t  AS A 
...
exec hye_SSLOilMonthSalesSave @xmlDocument=N'<ROOT>
  <DataBlock8>
    ...
    <cs_custom_name>등촌샤브샤브칼국수</cs_custom_name>
  ...
  <DataBlock8>
    ...
    <cs_custom_name>오비에스 경인티브이 주식회사</cs_custom_name>
  ...
  <DataBlock8>
    ...
    <cs_custom_name>연기퓨리나축우특약</cs_custom_name>
  ...
  <DataBlock8>
    ...
    <cs_custom_name>주식회사돌쇠출장세</cs_custom_name>
  ...
  <DataBlock8>
    ...
    <cs_custom_name>세종경찰서</cs_custom_name>
  ...
  <DataBlock8>
    ...
    <cs_custom_name>중부도시가스세종고객센터</cs_custom_name>
