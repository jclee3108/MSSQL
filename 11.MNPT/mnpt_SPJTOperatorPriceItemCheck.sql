...
IF OBJECT_ID('mnpt_SPJTOperatorPriceItemCheck') IS NOT NULL   
    DROP PROC mnpt_SPJTOperatorPriceItemCheck  
GO  
    
-- v2017.09.19
  
-- 운전원노임단가입력-SS2체크 by 이재천
CREATE PROC mnpt_SPJTOperatorPriceItemCheck      
    @ServiceSeq     INT = 0,         
...
AS       
    ...
    UPDATE #BIZ_OUT_DataBlock2  
      ...
      JOIN (SELECT S.UMToolType, S.StdSeq
              FROM (SELECT A1.UMToolType, A1.StdSeq
                    ...
                    SELECT A1.UMToolType, A1.StdSeq
                      FROM mnpt_TPJTOperatorPriceItem AS A1  
             ...
             GROUP BY S.UMToolType, S.StdSeq 
            HAVING COUNT(1) > 1  
           ) AS B ON ( A.UMToolType = B.UMToolType AND A.StdSeq = B.StdSeq )  
    ...
    SELECT @MaxSerl = MAX(A.StdSerl) 
     ...
     WHERE A.CompanySeq = @CompanySeq 
       AND EXISTS (SELECT 1 FROM #BIZ_OUT_DataBlock2 WHERE StdSeq = A.StdSeq) 
...
SELECT N'A', 1, 1, 0, 0, NULL, NULL, NULL, N'DataBlock3', NULL, NULL, N'서비스', N'2', N'21', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0' UNION ALL 
SELECT N'A', 2, 2, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, N'임희연소분류2테스트', N'3', N'3', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0' UNION ALL 
SELECT N'A', 3, 3, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, N'프로젝트별 품목생성 프로젝트', N'1', N'3', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0'
IF @@ERROR <> 0 RETURN
