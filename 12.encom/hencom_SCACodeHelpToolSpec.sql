IF OBJECT_ID('hencom_SCACodeHelpToolSpec') IS NOT NULL 
    DROP PROC hencom_SCACodeHelpToolSpec
GO 

-- v2017.02.22 

-- 부외재고관리규격 by이재천
CREATE PROCEDURE hencom_SCACodeHelpToolSpec
...
AS
    ...
    SELECT A.ItemSeq, A.ItemName, A.ItemNo, A.Spec, A.UnitSeq, B.UnitName
     ...
     WHERE A.CompanySeq = @CompanySeq 
       ...
       AND (@Keyword = '' OR A.Spec LIKE @Keyword+'%') 
