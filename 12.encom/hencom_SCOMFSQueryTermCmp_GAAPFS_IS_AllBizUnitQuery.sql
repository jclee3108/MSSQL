IF OBJECT_ID('hencom_SCOMFSQueryTermCmp_GAAPFS_IS_AllBizUnitQuery') IS NOT NULL 
    DROP PROC hencom_SCOMFSQueryTermCmp_GAAPFS_IS_AllBizUnitQuery
GO 
-- v2017.08.10
...
작성자 - 김일주
************************************************************/
CREATE PROC dbo.hencom_SCOMFSQueryTermCmp_GAAPFS_IS_AllBizUnitQuery
...
AS
    ...
    SELECT BizUnit, 
           ...
           SUM(ThisTermItemAmt) AS ThisTermItemAmt, 
    ...
    SELECT A.RowNum, A.FSItemNamePrt, SUM(A.ThisTermItemAmt), MAX(A.SMItemForeColorCode), MAX(A.SMItemBackColorCode)
      FROM #Result_Main AS A 
    ...
    INSERT INTO #Value ( BizUnit, RowNum, ThisTermItemAmt ) 
    SELECT BizUnit, RowNum, ThisTermItemAmt 
      FROM #Result_Main
...
--go
--begin tran 
--exec hencom_SCOMFSQueryTermCmp_GAAPFS_IS_AllBizUnitQuery @xmlDocument=N'<ROOT>
--  <DataBlock1>
...
--    <ToAccYM>201706</ToAccYM>
--    <PrevToAccYM>201608</PrevToAccYM>
--    <FrAccYM>201706</FrAccYM>
