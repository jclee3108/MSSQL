IF OBJECT_ID('hencom_SPDMESPartitionAddQueryAdd') IS NOT NULL 
    DROP PROC hencom_SPDMESPartitionAddQueryAdd
GO 
...
/************************************************************                                      
 ...
 작성자 - 영림원                                      
************************************************************/                                      
CREATE PROC dbo.hencom_SPDMESPartitionAddQueryAdd                                                      
...
go
begin tran 
exec hencom_SPDMESPartitionAddQueryAdd @xmlDocument=N'<ROOT>
  <DataBlock1>
