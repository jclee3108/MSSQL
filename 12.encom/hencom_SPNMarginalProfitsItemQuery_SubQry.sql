IF OBJECT_ID('hencom_SPNMarginalProfitsItemQuery_SubQry') IS NOT NULL 
    DROP PROC hencom_SPNMarginalProfitsItemQuery_SubQry
GO 
...
/************************************************************  
 ...
 작성자 - 박수영  
************************************************************/  
create PROC dbo.hencom_SPNMarginalProfitsItemQuery_SubQry                 
    @CompanySeq     INT  = 1,              
    @DeptSeq        INT    ,
    @PlanSeq        INT   
